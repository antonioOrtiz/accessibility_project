...
jQuery(function() {
    jQuery('.hover-container, #web-tv-lg-container').hover(function() {
        jQuery('.hover-div', this).animate({
            'bottom': '0px'
        }, 400);
    }, function() {
    ...
    jQuery('.hover-container-small, .small-image-container-left, .small-image-container-right, .smallImageContainerMiddle').hover(function() {
        jQuery('.hover-div-small', this).animate({
            'bottom': '0px'
        }, 400);
    }, function() {
